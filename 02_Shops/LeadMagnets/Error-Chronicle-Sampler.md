...
## 20 of 118 documented mistakes from building an AI operating system solo, in two weeks
...
> This sampler contains 20 hand-picked entries from the full chronicle of 118.
> No fluff, no theory: each of these actually broke, on a real machine, and each
> prevention rule below exists because it had to.
>
> **The full chronicle (all 118, plus every script and config) ships with
